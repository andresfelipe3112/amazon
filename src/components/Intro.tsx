    ...
    return (
        <div className="containerInicial">
            ...
            <div className="imagen">
                ...
                <iframe width="660" height="355" src="https://www.youtube.com/embed/v4EY3UIhbqI" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" ></iframe>
            </div>
        </div>
    )
}
